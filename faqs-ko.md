...
**<a name="a1"></a> iOS 캘린더와 구글 캘린더는 어떻게 동기화 하나요?**
> iOS 캘린더를 구글 캘린더와 동기화하려면 다음 구글 가이드를 참조하세요 :
> Apple 기기 Google Sync 설정

**<a name="a1"></a> 날씨 정보가 표시되지 않거나 부정확합니다**
...
**<a name="a1"></a> 음력 기념일은 어떻게 추가 하나요?**
